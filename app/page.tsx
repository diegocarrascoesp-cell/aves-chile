  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-green-900 to-green-700 text-white">
      <section className="flex min-h-screen flex-col items-center justify-center px-6 text-center">
        <h1 className="text-5xl font-bold md:text-7xl">Aves de Chile</h1>
        ...
        <div className="mt-10 flex gap-4">
          <a
            href="/especies"
            className="rounded-2xl bg-white px-6 py-3 font-semibold text-green-900 transition hover:scale-105"
          >
            Explorar especies
          </a>
          ...
          <a
            href="/especies"
            className="rounded-2xl border border-white px-6 py-3 transition hover:bg-white hover:text-green-900"
          >
            Ver galería
          </a>
        </div>
      ...
      <section className="px-6 py-20 text-center">
        ...
        <a
          href="/especies"
          className="mt-8 inline-block rounded-2xl bg-white px-8 py-4 font-semibold text-green-900 transition hover:scale-105"
        >
          Ir a especies
        </a>
      </section>
